...
class Renderer {
  ...
  reset(
    ...
    this.boxSize = this.boxEditor.boxes[0].max;
  }
  ...
  drawSphere(projectionMatrix, viewMatrix) {
    ...
    let sphereDrawState = wgl
      ...
      .uniformTexture(
        ...
        3,
        wgl.TEXTURE_2D,
        this.simulator.particleInitPositionTexture
      )
      .uniform2f("u_textureSize", this.boxSize[2], this.boxSize[0])
  ...
  draw() {
    ...
    // * Test Draw Texture
    // this.drawTmpTexture(this.simulator.particlePositionTexture);
    // this.drawTmpTexture(this.occlusionTexture);
